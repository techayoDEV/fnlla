...
if (developer_access()->enabled()) {
    ...
    $developerRoutes = [
        ...
        ["get", $developerPanel("/my-todo"), DeveloperWorkspaceController::class, "privateTodo", "developer.panel.private_todo", "developer-session"],
        ...
        ["post", $developerPanel("/my-todo/items"), DeveloperWorkspaceController::class, "createPrivateTodo", "developer.private_todo.items.create", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-todo/items/update"), DeveloperWorkspaceController::class, "updatePrivateTodo", "developer.private_todo.items.update", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-todo/items/toggle"), DeveloperWorkspaceController::class, "togglePrivateTodo", "developer.private_todo.items.toggle", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-todo/items/delete"), DeveloperWorkspaceController::class, "deletePrivateTodo", "developer.private_todo.items.delete", ["csrf", "developer-session"]],
