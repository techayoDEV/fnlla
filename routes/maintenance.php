...
if (developer_access()->enabled()) {
    ...
    $developerRoutes = [
        ...
        ["get", $developerPanel("/debug/live"), DeveloperDebugController::class, "live", "developer.panel.debug.live", "developer-session"],
        ["post", $developerPanel("/debug"), DeveloperDebugController::class, "save", "developer.panel.debug.save", ["csrf", "developer-session"]],
        ["post", $developerPanel("/debug/runtime-issues/promote"), DeveloperDebugController::class, "promoteRuntimeIssue", "developer.panel.debug.runtime_issues.promote", ["csrf", "developer-session"], [20, 1]],
        ...
        ["get", $developerPanel("/project-identity/identity"), DeveloperProjectController::class, "projectIdentityDetails", "developer.panel.project_identity.identity", "developer-session"],
        ["get", $developerPanel("/project-identity/runtime"), DeveloperProjectController::class, "projectIdentityRuntime", "developer.panel.project_identity.runtime", "developer-session"],
        ["get", $developerPanel("/project-identity/leadership"), DeveloperProjectController::class, "projectIdentityLeadership", "developer.panel.project_identity.leadership", "developer-session"],
        ["get", $developerPanel("/project-identity/access-preview"), DeveloperProjectController::class, "projectIdentityAccessPreview", "developer.panel.project_identity.access", "developer-session"],
        ...
        ["get", $developerPanel("/access/developer"), DeveloperAccountController::class, "developerAccessSettings", "developer.panel.access.developer", "developer-session"],
        ["get", $developerPanel("/access/client"), DeveloperAccountController::class, "clientReviewAccessSettings", "developer.panel.access.client", "developer-session"],
        ...
        ["get", $developerPanel("/changelog"), DeveloperOperationsController::class, "changelog", "developer.panel.changelog", "developer-session"],
        ["post", $developerPanel("/changelog"), DeveloperOperationsController::class, "storeChangelogEntry", "developer.panel.changelog.store", ["csrf", "developer-session"]],
        ...
        ["get", $developerPanel("/heatmap/page/{page}"), DeveloperInsightsController::class, "heatmap", "developer.panel.heatmap.page", "developer-session"],
        ...
        ["get", $developerPanel("/tasks"), DeveloperWorkspaceController::class, "workspace", "developer.panel.workspace", "developer-session"],
        ["get", $developerPanel("/workspace"), DeveloperWorkspaceController::class, "redirectWorkspace", "developer.panel.workspace.legacy", "developer-session"],
        ["get", $developerPanel("/my-tasks"), DeveloperWorkspaceController::class, "privateTodo", "developer.panel.private_todo", "developer-session"],
        ["get", $developerPanel("/my-todo"), DeveloperWorkspaceController::class, "redirectPrivateTodo", "developer.panel.private_todo.legacy", "developer-session"],
        ...
        ["post", $developerPanel("/settings/runtime-environment"), DeveloperProjectController::class, "updateRuntimeEnvironment", "developer.settings.runtime_environment", ["csrf", "developer-session"]],
        ...
        ["post", $developerPanel("/settings/service-control/public-view-test"), DeveloperProjectController::class, "testServiceControlPublicView", "developer.settings.service_control.public_view_test", ["csrf", "developer-session"]],
        ...
        ["post", $developerPanel("/tasks/items"), DeveloperWorkspaceController::class, "createWorkspaceTask", "developer.workspace.tasks.create", ["csrf", "developer-session"]],
        ["post", $developerPanel("/tasks/items/update"), DeveloperWorkspaceController::class, "updateWorkspaceTask", "developer.workspace.tasks.update", ["csrf", "developer-session"]],
        ["post", $developerPanel("/tasks/items/delete"), DeveloperWorkspaceController::class, "deleteWorkspaceTask", "developer.workspace.tasks.delete", ["csrf", "developer-session"]],
        ["post", $developerPanel("/workspace/tasks"), DeveloperWorkspaceController::class, "createWorkspaceTask", "developer.workspace.tasks.create.legacy", ["csrf", "developer-session"]],
        ["post", $developerPanel("/workspace/tasks/update"), DeveloperWorkspaceController::class, "updateWorkspaceTask", "developer.workspace.tasks.update.legacy", ["csrf", "developer-session"]],
        ["post", $developerPanel("/workspace/tasks/delete"), DeveloperWorkspaceController::class, "deleteWorkspaceTask", "developer.workspace.tasks.delete.legacy", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-tasks/items"), DeveloperWorkspaceController::class, "createPrivateTodo", "developer.private_todo.items.create", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-tasks/items/update"), DeveloperWorkspaceController::class, "updatePrivateTodo", "developer.private_todo.items.update", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-tasks/items/toggle"), DeveloperWorkspaceController::class, "togglePrivateTodo", "developer.private_todo.items.toggle", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-tasks/items/delete"), DeveloperWorkspaceController::class, "deletePrivateTodo", "developer.private_todo.items.delete", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-todo/items"), DeveloperWorkspaceController::class, "createPrivateTodo", "developer.private_todo.items.create.legacy", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-todo/items/update"), DeveloperWorkspaceController::class, "updatePrivateTodo", "developer.private_todo.items.update.legacy", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-todo/items/toggle"), DeveloperWorkspaceController::class, "togglePrivateTodo", "developer.private_todo.items.toggle.legacy", ["csrf", "developer-session"]],
        ["post", $developerPanel("/my-todo/items/delete"), DeveloperWorkspaceController::class, "deletePrivateTodo", "developer.private_todo.items.delete.legacy", ["csrf", "developer-session"]],
