...
File: src\Middleware\RequireDeveloperSession.php
...
Purpose:
- Requires an unlocked developer session before hidden developer panel actions
  can mutate maintenance or developer access settings.
*/
