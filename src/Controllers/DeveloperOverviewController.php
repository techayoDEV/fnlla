        ...
        return [
            ...
            "boundary" => [
                "fnlla_managed" => [
                    ...
                    "Privacy-light operational summaries, consent-aware integration hooks and reserved FIONN AI bridge policy.",
                ...
                "forbidden_in_fnlla_core" => [
                    ...
                    "The private FIONN AI brain, learned memory, model weights, queues or eval data.",
