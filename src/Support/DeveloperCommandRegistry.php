...
final class DeveloperCommandRegistry
{
    private const DEFINITIONS = [
        ...
        [
            ...
            "link" => "developer_access",
            "group" => "Operations",
            "description" => "Manage developer accounts, roles, sessions, 2FA and passkey readiness.",
            "aliases" => ["security", "access", "developer accounts", "2fa", "totp", "mfa"],
            "kind" => "Configure",
            "priority" => 12,
            "environment_policy" => "all",
        ],
        [
            "id" => "client_review_access",
            "label" => "Client review access",
            "link" => "client_review_access",
            "group" => "Operations",
            "description" => "Manage customer portal invitations, review permissions and the private client review route.",
            "aliases" => ["client", "customer", "portal", "invitation", "review access"],
            "kind" => "Configure",
            "priority" => 13,
