...
final class FnllaPackageExporter
{
    public function convert(string $target): void
    {
        ...
        foreach (["fnlla-core", "fnlla"] as $package) {
        ...
        foreach ($export["files"] as $path) {
            ...
            $package = isset($coreFiles[$path]) ? "fnlla-core" : "fnlla";
        ...
        $this->write($target . "/.fnlla/package-distribution", "core-fnlla-v1\n");
