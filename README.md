...
[![Source edition](https://img.shields.io/badge/source-2.2.5-2563eb?style=flat-square)](./VERSION)
...
php fnlla release:prepare --target=2.2.5
```
...
Source edition: **2.2.5**. Use the published, versioned downloads from
