...
[![Source edition](https://img.shields.io/badge/source-2.2.4-2563eb?style=flat-square)](./VERSION)
...
php fnlla release:prepare --target=2.2.4
```
...
Source edition: **2.2.4**. Use the published, versioned downloads from
