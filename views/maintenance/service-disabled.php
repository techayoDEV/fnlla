...
$serviceContactUrl = trim((string) ($developerControl["contact_url"] ?? ""));
      ...
      <div class="card-body client-preview-card-body">
        ...
        <header class="client-preview-header">
          <div class="client-preview-header-copy">
            ...
            <dl class="client-preview-meta">
              <div>
                <dt class="client-preview-meta-label">Status:</dt>
                <dd class="client-preview-meta-value"><?= h($serviceStatusLabel) ?></dd>
              </div>
              <?php if ($serviceReason !== ""): ?>
              <div>
                <dt class="client-preview-meta-label">Reason:</dt>
                <dd class="client-preview-meta-value"><?= h($serviceReasonLabel) ?></dd>
              </div>
              <?php endif; ?>
            </dl>
          </div>
        ...
        <?php if ($serviceContact !== "" || $serviceContactUrl !== "" || $serviceContactPhone !== ""): ?>
        <div class="client-preview-support-row">
          ...
          <div class="client-preview-support-copy">
            <strong><?= h($serviceProvider !== "" ? "Contact " . $serviceProvider : "Contact support") ?></strong>
            <?php if ($serviceContactUrl !== ""): ?>
            <p class="client-preview-note-text"><a class="client-preview-support-link" href="<?= h($serviceContactUrl) ?>"><?= h($serviceContactUrl) ?></a></p>
            <?php endif; ?>
