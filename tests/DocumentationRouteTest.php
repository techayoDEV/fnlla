...
final class DocumentationRouteTest extends TestCase
{
    ...
    public function testDocsOverviewPageIsServedThroughApplicationRoute(): void
    {
        ...
        self::assertSame(200, $response->status());
        self::assertStringContainsString("FNLLA PHP Documentation", $response->body());
        ...
        self::assertStringContainsString("/vendor/fnlla-web/assets/js/fnlla-web.js", $response->body());
    }
