...
return [
    ...
    "disabled_contact_phone" => (string) env("DEVELOPER_CONTROL_DISABLED_CONTACT_PHONE", ""),
    ...
    "suspended_contact_phone" => (string) env("DEVELOPER_CONTROL_SUSPENDED_CONTACT_PHONE", ""),
    "remote" => [
