...
return [
    ...
    "disabled_title" => (string) env("DEVELOPER_CONTROL_DISABLED_TITLE", "Service paused by developer"),
    "disabled_message" => (string) env("DEVELOPER_CONTROL_DISABLED_MESSAGE", "This service is temporarily paused by the developer team. Please contact the project developer for assistance."),
    "disabled_contact" => (string) env("DEVELOPER_CONTROL_DISABLED_CONTACT", "developer@example.com"),
    "disabled_contact_url" => (string) env("DEVELOPER_CONTROL_DISABLED_CONTACT_URL", "https://example.com/support"),
    "disabled_contact_phone" => (string) env("DEVELOPER_CONTROL_DISABLED_CONTACT_PHONE", "+44 20 0000 0000"),
    "service_provider" => (string) env("DEVELOPER_CONTROL_SERVICE_PROVIDER", ""),
    "suspended_title" => (string) env("DEVELOPER_CONTROL_SUSPENDED_TITLE", "Service has been suspended"),
    ...
    "suspended_contact_url" => (string) env("DEVELOPER_CONTROL_SUSPENDED_CONTACT_URL", env("DEVELOPER_CONTROL_DISABLED_CONTACT_URL", "https://example.com/support")),
    "suspended_contact_phone" => (string) env("DEVELOPER_CONTROL_SUSPENDED_CONTACT_PHONE", env("DEVELOPER_CONTROL_DISABLED_CONTACT_PHONE", "+44 20 0000 0000")),
    "remote" => [
