...
return [
    ...
    "title" => trim((string) env("CLIENT_PREVIEW_TITLE", "Private client preview is active")),
    ...
    "status_title" => trim((string) env("CLIENT_PREVIEW_STATUS_TITLE", "Password-protected preview mode is enabled")),
    "status_body" => trim((string) env("CLIENT_PREVIEW_STATUS_BODY", "This project is online for client review, but public access is locked until the preview password is entered.")),
    "countdown_label" => trim((string) env("CLIENT_PREVIEW_COUNTDOWN_LABEL", "Preview window closes in")),
    ...
    "progress_label" => trim((string) env("CLIENT_PREVIEW_PROGRESS_LABEL", "Preview window progress")),
    "message" => trim((string) env("CLIENT_PREVIEW_MESSAGE", "Use the client preview password supplied by the project team to review the current build before public launch.")),
    ...
    "locked_notice" => trim((string) env("CLIENT_PREVIEW_LOCKED_NOTICE", "Preview unlock is temporarily unavailable while the project team reviews access.")),
];
