# FNLLA Runtime Trademark Notice

## Brand ownership

`FNLLA`, `FNLLA Runtime`, `FNLLA PHP` and related product branding are names associated with TechAyo LTD (techayo.co.uk).
...
- to say that a project is built with FNLLA Runtime
...
- present a fork or derivative as the official FNLLA Runtime project
...
- publish a modified framework under the FNLLA Runtime product identity as though it were the official maintained release
