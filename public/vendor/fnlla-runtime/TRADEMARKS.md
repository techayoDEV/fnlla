# FNLLA Integrated UI Surface Trademark Notice

## Brand ownership

`FNLLA`, `FNLLA PHP` and related product branding are names associated with
TechAyo LTD (techayo.co.uk). The official FNLLA product website is
`https://fnlla.com`.
...
- present a fork or derivative as the official FNLLA project or its official integrated UI surface
