# FNLLA Composer package preview

This export uses techayodev/fnlla-core and techayodev/fnlla as real
...
The package names map directly to the product names: FNLLA and FNLLA Core.
...
techayodev/fnlla, then run project tests. Commit composer.lock. Publish
...
Do not delete fnlla from this preset and expect application routes and
